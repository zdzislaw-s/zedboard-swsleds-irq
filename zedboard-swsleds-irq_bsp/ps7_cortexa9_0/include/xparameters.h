...
#define XPAR_LEDS_GPIO_BASEADDR 0x41210000
#define XPAR_LEDS_GPIO_HIGHADDR 0x4121FFFF
#define XPAR_LEDS_GPIO_DEVICE_ID 0
#define XPAR_LEDS_GPIO_INTERRUPT_PRESENT 0
#define XPAR_LEDS_GPIO_IS_DUAL 0


/* Definitions for peripheral SWS_GPIO */
#define XPAR_SWS_GPIO_BASEADDR 0x41200000
#define XPAR_SWS_GPIO_HIGHADDR 0x4120FFFF
#define XPAR_SWS_GPIO_DEVICE_ID 1
#define XPAR_SWS_GPIO_INTERRUPT_PRESENT 1
#define XPAR_SWS_GPIO_IS_DUAL 0
...
#define XPAR_GPIO_0_DEVICE_ID XPAR_LEDS_GPIO_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral SWS_GPIO */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_SWS_GPIO_DEVICE_ID
...
#define XPAR_FABRIC_SWS_GPIO_IP2INTC_IRPT_INTR 61U
